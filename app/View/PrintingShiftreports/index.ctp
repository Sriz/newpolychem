...
?>
	   <td>   <button class="btn btn-primary" onclick="window.location.href='<?php echo Router::url(array('controller'=>'PrintingShiftreports', 'action'=>'add'))?>'">Add</button>
</td>
	   <td>   <button class="btn btn-primary" onclick="window.open('<?php echo Router::url(array('controller'=>'PrintingShiftreports', 'action'=>'download_pdf'))?>')">Print</button></td>
	   </tr>
				</table></div>
    </div>
 ...
 <div class="row">
	...
	<tr>
			...
			<!--<th><//?php echo $this->Paginator->sort('unprinted_scrap_reason'); ?></th>
			<!--<th><?php// echo $this->Paginator->sort('department_id'); ?></th> -->
			<th style="text-align:right"><?php echo $this->Paginator->sort('printed_scrap'); ?></th>
			<!--<th><?//php echo $this->Paginator->sort('printed_scrap_reason'); ?></th> -->
	...
	<tr class="success">
		...
		<td align="right"><?php echo h(number_format($printingShiftreport['PrintingShiftreport']['input'],2)); ?>&nbsp;</td>
		<td align="right"><?php echo h(number_format($printingShiftreport['PrintingShiftreport']['output'],2)); ?>&nbsp;</td>
		<td align="right"><?php echo h(number_format($printingShiftreport['PrintingShiftreport']['unprinted_scrap'],2)); ?>&nbsp;</td>
		<!--<td><?//php echo h($printingShiftreport['PrintingShiftreport']['unprinted_scrap_reason']); ?>&nbsp;</td>-->
		<!--<td><?php echo h($printingShiftreport['PrintingShiftreport']['department_id']); ?>&nbsp;</td> -->
		<td align="right"><?php echo h(number_format($printingShiftreport['PrintingShiftreport']['printed_scrap'],2)); ?>&nbsp;</td>
		<!--<td><?php //echo h($printingShiftreport['PrintingShiftreport']['printed_scrap_reason']); ?>&nbsp;</td> -->
...
<tr><td align="right"><strong>Total</strong></td><td></td><td></td><td></td><td></td><td align="right"><strong><?php echo number_format($tot['0']['totalinput'],2); ?><strong></td><td align="right"><strong><?php echo number_format($tot['0']['totaloutput'],2); ?></strong></td><td align="right"><strong><?php echo number_format($tot['0']['totalu'],2); ?></strong></td><td align="right"><strong><?php echo number_format($tot['0']['totals'],2); ?></strong></td></tr>
	<?php endforeach; ?>
	</table>
	<p>
	<?php
