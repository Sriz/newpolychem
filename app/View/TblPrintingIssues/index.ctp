                ...
                if (!count($consumptions)):
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach ($material_lists as $m): ?>
                            <tr>
                                <td class="success"><?= $m['PrintingPattern']['pattern_name']; ?></td>
                                <?php for ($i = 0; $i < count($consumptions); $i++): ?>
                                    <td>
                                        <?php
                                        $materials = json_decode($consumptions[$i]['TblPrintingIssue']['patterns']);
                                            echo isset($materials->$m['PrintingPattern']['id']) ? $materials->$m['PrintingPattern']['id'] ? $materials->$m['PrintingPattern']['id'] : 0 : 0;
                                        ?>
                                    </td>
                                <?php endfor; ?>
                            </tr>
